...
class CHIP8:
    ...
    def some_really_useful_functions(self):
        ...
        if arg == 0x07:
            ...
            for reg_num in range(x + 1):
                self.MEMORY[self.REGISTERS['I'] + reg_num] = self.REGISTERS['GPR'][reg_num]
        elif arg == 0x65:
            # Read registers V0 through Vx from memory starting at location I.
            for reg_num in range(x + 1):
                self.REGISTERS['GPR'][reg_num] = self.MEMORY[self.REGISTERS['I'] + reg_num]
    ...
    def JP_V0(self) -> None:
        ...
        :return: None
        """
        self.REGISTERS['pc'] = (self.current_instruction & 0x0FFF) + self.REGISTERS['GPR'][0]
    ...
    def SNE_REG_VAL(self) -> None:
        ...
        compare_value = self.current_instruction & 0x0FF
    ...
    def CALL(self) -> None:
        ...
        :return: None
        """
        self.REGISTERS['stack'].push(self.REGISTERS['pc'] & 0x00FF)
        self.REGISTERS['stack'].push(self.REGISTERS['pc'] & 0xFF00)
    ...
    def RET(self) -> None:
        ...
        :return: None
        """
        high = self.REGISTERS['stack'].pop() << 8
        low = self.REGISTERS['stack'].pop()
    ...
    def LOGIC_INSTRUCTIONS(self) -> None:
        ...
        if last_4_bits == 1:
            ...
            # Set Vx = Vx SHL 1.
            # If the most-significant bit of Vx is 1, then VF is set to 1, otherwise to 0. Then Vx is multiplied by 2.
            most_significant_bit = (x_reg_value & 0x80) >> 8
